...
public class ProductDaoImpl implements ProductDao {
    ...
    public List<Product> getProducts(ProductQueryParams productQueryParams) {
       ...
       sql = addFilteringSql(sql, map, productQueryParams);
        ...
        //分頁
        sql = sql + " offset :offset Rows FETCH FIRST :Fetch Rows only";
        map.put("offset", productQueryParams.getOffset());
        map.put("Fetch", productQueryParams.getLimit());
    ...
    public void updateProduct(Integer productId, ProductRequest productRequest) {
        String sql = """
                    UPDATE product SET product_name = :productName, category = :category, image_url = :imageUrl, price=:price, stock=:stock, description=:description, last_modified_date=:lastModifiedDate WHERE product_id = :productId
                """;
